...
## Global flag to control debug messages
debug_flag       = False



def debug(debug_en=True):
    """
    debug()
        Call this function from instrumentation code to enable
        and disable debug messages.
        Exported in the __init__.py file
    """
    global debug_flag
    debug_flag = debug_en
    return
...
class DLProf(object):
        ...
        for input_id, _ in enumerate(input_tensors):
            ...
            if input_ptr in cls.op_to_out_tensor_map:
                ...
                if input_callid_info not in input_callid_list:
                    ...
                    dprint("Callid {} Input tensor ptr {} fetching saved call_id {} port {}"\
                            .format(call_id, input_ptr, input_callid_info, 0))
            else:
    ...
    def capture_outputs(cls, call_id, result):
        ...
        dprint("call_id {} output tensors {}".format(call_id, output_tensors))
